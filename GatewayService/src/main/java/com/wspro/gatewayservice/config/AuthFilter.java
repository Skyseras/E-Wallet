package com.wspro.gatewayservice.config;

import com.wspro.gatewayservice.Dto.AppUserDto;
import com.wspro.gatewayservice.Dto.ResponseDto;
        ...
        if (parts.length !=2 || !"Bearer".equals(parts[0])){
            ...
            return webClientBuilder.build()
                    ...
                    .map(response -> {
                        ...
                        exchange.getRequest()
                                .mutate()
                                .header("X-auth-user-id", String.valueOf(((AppUserDto) response.getData()).getId()));
                        return exchange;
